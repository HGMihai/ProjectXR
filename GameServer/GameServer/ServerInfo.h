...
{
	bool CustomStatsAdd;
	bool CustomExpandedCharacters;
	bool CustomOfflineMode;
	bool CustomPartySearch;
	bool CustomSmithy;
	bool CustomBuffIcon;
	bool CustomEventTimer;
	bool CustomGuildWarehouse;
	bool CustomAchievements;
	bool CustomRankings;
	bool CustomOptionReplace;
	bool CustomQuestSystem;
	bool CustomActiveInvasions;
	bool CustomStat;
};
...
struct PMSG_SERVERINFO_SEND
{
	...
	int CustomResetPoint[MAX_ACCOUNT_LEVEL];
	int CustomResetPointPriceWC[MAX_ACCOUNT_LEVEL];
	int CustomResetPointPricePoint[MAX_ACCOUNT_LEVEL];
	...
	BYTE new_bc_level_rule;
	BYTE new_ds_level_rule;
	BYTE new_it_level_rule;	
	int CustomStoreEnableJoB;
	int CustomStoreEnableJoS;
	int CustomStoreEnableJoC;
	int CustomStoreEnableWCC;
	int CustomStoreEnableWCP;
	int CustomStoreEnableWCG;
	int ExtendedCharacters;
	int AutoHealEnable;
	int CanUseAutoHealth;
	int Strength;
	int Dexterity;
	int Vitality;
	int Energy;
...
public:
	...
	int m_ServerMinUserGReset;
	int m_ServerMaxUserGReset;
	...
	int m_ShowKillMessage;
	int m_MonsterHealthBarSwitch;
	int m_QuestNPCTeleport;
	int m_QuestNPCTeleportTime;
	int m_NonPK;
	int m_PKLimitFree;
	int m_PKDownTime1;
	int m_PKDownTime2;
	int m_MaxPKCount;
	int m_MaxPKKillCount;
	int m_TradeSwitch;
	...
	int m_MaxExperienceMonsterLevel[MAX_ACCOUNT_LEVEL];
	...
	int m_MoneyMasterAmountDropRate[MAX_ACCOUNT_LEVEL];
	...
	int m_CharacterDeleteGReset[MAX_ACCOUNT_LEVEL];
	int m_CharacterDeleteReset[MAX_ACCOUNT_LEVEL];
	int m_CharacterDeleteLevel[MAX_ACCOUNT_LEVEL];
	...
	int m_PartyUseOriginalPartyExpFormula;

	int gParty3ExpPercent;
	int gParty4ExpPercent;
	int gParty5ExpPercent;
	int gPartyExpPercentOther;

	int gParty2ExpSetPercent;
	int gParty3ExpSetPercent;
	int gParty4ExpSetPercent;
	int gParty5ExpSetPercent;
	int gParty1ExpSetPercent;
	...
	int m_BloodCastleNewLevelSettings;
	int m_BloodCastleMaxDayEntry[MAX_ACCOUNT_LEVEL];
	...
	int m_CastleSiegeResetAccumulationAfterKill;
	...
	int m_DevilSquareNewLevelSettings;
	int m_DevilSquareMaxDayEntry[MAX_ACCOUNT_LEVEL];
	...
	int m_IllusionTempleNewLevelSettings;	
	...
	int m_NewWingMixRate_Part1[MAX_ACCOUNT_LEVEL];
	int m_NewWingMixRate_Part2[MAX_ACCOUNT_LEVEL];
	int m_RemoveRFWings;
	int m_RemoveSUWings;
	int m_SeniorMixPrice;
	...
	int m_CommandResetNeedItem;
	int m_CommandResetItemID;
	int m_CommandResetItemLevel;
	int m_CommandResetItemCount[MAX_ACCOUNT_LEVEL];
	int m_CommandResetItemGR;
	int m_CommandResetGiveCredits[MAX_ACCOUNT_LEVEL];
	...
	int m_CommandBanChatSwitch;
	int m_CommandBanChatGameMasterLevel;
	int m_CommandMLResetSwitch;
	int m_CommandMLResetPrice_Zen[MAX_ACCOUNT_LEVEL];
	int m_CommandMLResetPrice_WCoinC[MAX_ACCOUNT_LEVEL];
	int m_CommandMLResetPrice_WCoinP[MAX_ACCOUNT_LEVEL];
	int m_CommandMLResetPrice_WCoinG[MAX_ACCOUNT_LEVEL];
	int m_CommandMLResetPrice_Credits[MAX_ACCOUNT_LEVEL];
	...
	int m_CustomNoobBuffMaxReset[MAX_ACCOUNT_LEVEL];
	int m_CustomGuildBuffConstA;
	int m_CustomGuildBuffStartReset;
	int m_CustomGuildBuffMin;
	int m_CustomGuildBuffMax;
	...
	int m_DisconnectOnConenct[MAX_ACCOUNT_LEVEL];
	int m_AutoHealthPotionEnable;
	int m_UseAutoHealthPotion[MAX_ACCOUNT_LEVEL];
	int m_AutoHealthPotionDelay[MAX_ACCOUNT_LEVEL];
	int m_CustomCharInterface[MAX_ACCOUNT_LEVEL];
	int m_CustomResetPoint[MAX_ACCOUNT_LEVEL];
	int m_CustomResetPointPriceWC[MAX_ACCOUNT_LEVEL];
	int m_CustomResetPointPricePoint[MAX_ACCOUNT_LEVEL];
	int m_ExtendedCharacters[MAX_ACCOUNT_LEVEL];
