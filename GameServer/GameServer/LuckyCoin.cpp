...
void CLuckyCoin::DGLuckyCoinExchangeRecv(SDHP_LUCKY_COIN_EXCHANGE_RECV* lpMsg) // OK
{
	...
	GDCreateItemSend(lpObj->Index,0xEB,0,0,item.m_Index,(BYTE)item.m_Level,0,item.m_SkillOption,item.m_LuckOption,item.m_Option,-1,item.m_NewOption,0,0,0,item.m_SocketOption,item.m_SocketOptionBonus,0);
