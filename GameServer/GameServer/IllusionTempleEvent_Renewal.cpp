...
//	this->Load_ITR_NPC_Position(gPath.GetFullPath("Event\\IllusionTemple_Renewal\\IGC_IllusionTemple_Renewal_NPC.xml"));
//	//this->Load_ITR_Script(g_ConfigRead.GetPath("\\Events\\IllusionTemple_Renewal\\IGC_IllusionTemple_Renewal.xml"));
//	this->Load_ITR_Script(gPath.GetFullPath("Event\\IllusionTemple_Renewal\\IGC_IllusionTemple_Renewal.xml"));
//
//	return TRUE;
//}
//
...
//	{
//		ErrorMessageBox("[ ITR ] IllusionTempleRenewalNpc.xml File Load Fail %s (%s)", filename, res.description());
...
//	if (res.status != pugi::status_ok)
//	{
//		ErrorMessageBox("[Illusion Temple] Info file Load Fail [%s] [%s]", filename, res.description());
...
//
//	this->SetEventEnable(itr.attribute("Enable").as_bool());
...
//	}
//
//	this->m_cITR_Proc[lpObj->Map - 45].SendRelicsUserInfo(lpObj, 0);
//}
//
...
//		LogAdd(LOG_BLACK,"[ ITR ] ITR index:(%d) EnterUser: (%s)(%s) class:%d",
//			byTempleIndex + 1, lpObj->Account, lpObj->Name, lpObj->DBClass);
//
//		this->m_cITR_Proc[byTempleIndex].SendIllusionTempleState(0, lpObj->Index);
//
//		return TRUE;
//	}
//
//	else
//	{
//		LogAdd(LOG_BLACK,"[ ITR ] ITR index:(%d) EnterUser FAIL: (%s)(%s) class:%d",
//			byTempleIndex + 1, lpObj->Account, lpObj->Name, lpObj->DBClass);
//
//		return FALSE;
//	}
...
//			ErrorMessageBox("[ ITR ] Npc has Wrong Map Number (%d)", this->m_ITR_NPC[i].byMapNumber);
//			return;
//		}
//
...
//		LogAdd(LOG_BLACK, "ITR_UseSkill Error #1 iIndex :%d ", iIndex);
//		return;
//	}
//
//	if (!IT_MAP_RANGE(gObj[iIndex].Map))
//	{
//		//g_Log.Add("ITR_UseSkill Error #2 iIndex :%d Map:%d ", iIndex, gObj[iIndex].MapNumber);
//		LogAdd(LOG_BLACK, "ITR_UseSkill Error #2 iIndex :%d Map:%d ", iIndex, gObj[iIndex].Map);
//		return;
//	}
//
//	this->m_cITR_Proc[gObj[iIndex].Map - 45].ITR_UseSkill(iIndex, MagicNumber, wTargetObjIndex, btDis);
//}
//
//void CIllusionTempleEvent_Renewal::EventSkillProc(OBJECTSTRUCT* lpObj)
//{
//	return this->m_cITR_Proc[lpObj->Map - 45].ITRSkillProc(lpObj);
//}
//
//void CIllusionTempleEvent_Renewal::IllusionTempleUserDie(OBJECTSTRUCT *lpObj)
//{
//	this->m_cITR_Proc[lpObj->Map - 45].ITRUserDie(lpObj);
//}
//
...
//	}
//
//	if (this->m_cITR_Proc[lpObj->Map - 45].GetIllusionTempleState() == 2)
//	{
//		this->m_cITR_Proc[lpObj->Map - 45].UseSkillProdection(lpObj);
//	}
//}
//
...
//		return FALSE;
//
//	if (gObj[nUserIndex].Inventory[10].IsItem() == TRUE)
//	{
//		if (gObj[nUserIndex].Inventory[10].m_Index == GET_ITEM(13,10))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[10].m_Index == GET_ITEM(13,39))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[10].m_Index == GET_ITEM(13,40))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[10].m_Index == GET_ITEM(13,41))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[10].m_Index == GET_ITEM(13,68))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[10].m_Index == GET_ITEM(13,76))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[10].m_Index == GET_ITEM(13,77))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[10].m_Index == GET_ITEM(13,78))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[10].m_Index == GET_ITEM(13,122))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[10].m_Index == GET_ITEM(13,163))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[10].m_Index == GET_ITEM(13,164))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[10].m_Index == GET_ITEM(13,166))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[10].m_Index == GET_ITEM(13,169))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[10].m_Index == GET_ITEM(13,170))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[10].m_Index == GET_ITEM(13,268))
//			return TRUE;
//	}
//
//	if (gObj[nUserIndex].Inventory[11].IsItem() == TRUE)
//	{
//		if (gObj[nUserIndex].Inventory[11].m_Index == GET_ITEM(13,10))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[11].m_Index == GET_ITEM(13,39))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[11].m_Index == GET_ITEM(13,40))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[11].m_Index == GET_ITEM(13,41))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[11].m_Index == GET_ITEM(13,68))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[11].m_Index == GET_ITEM(13,76))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[11].m_Index == GET_ITEM(13,77))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[11].m_Index == GET_ITEM(13,78))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[11].m_Index == GET_ITEM(13,122))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[11].m_Index == GET_ITEM(13,163))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[11].m_Index == GET_ITEM(13,164))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[11].m_Index == GET_ITEM(13,166))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[11].m_Index == GET_ITEM(13,169))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[11].m_Index == GET_ITEM(13,170))
//			return TRUE;
//		if (gObj[nUserIndex].Inventory[11].m_Index == GET_ITEM(13,268))
//			return TRUE;
//	}
//	
//	return FALSE;
...
//		case GET_ITEM(13,163):
//		case GET_ITEM(13,164):
//		case GET_ITEM(13,165):
//		case GET_ITEM(13,166):
//		case GET_ITEM(13,169):
//		case GET_ITEM(13,170):
//		case GET_ITEM(13,268):
//			bRet = 1;
//			break;
//		default:
//			return bRet;
...
//	}
//
//	if (!OBJECT_RANGE(nIndex))
//	{
//		return FALSE;
//	}
//
//	if (!IT_MAP_RANGE(gObj[nIndex].Map))
//	{
//		return FALSE;
//	}
//
//	if (this->m_cITR_Proc[gObj[nIndex].Map - 45].GetIllusionTempleState() != 2)
//	{
//		return FALSE;
//	}
//
//	if (nIndex == this->m_cITR_Proc[gObj[nIndex].Map - 45].GetRelicsUserIndex(&gObj[nIndex]))
//	{
//		return TRUE;
//	}
//
...
//	}
//
//	this->m_cITR_Proc[gObj[nIndex].Map - 45].DropITR_RewardBox(nIndex);
//}
//
...
//						{
//							if (gObj[nIndex].Level != 400 || gObj[nIndex].ChangeUp == 2)
//							{
//								if (gObj[nIndex].Level == 400 && gObj[nIndex].ChangeUp)
