...
public:
	...
	int GetUserAbleLevelNew(LPOBJ lpObj);
...
private:
	...
	int m_DevilSquareRewardML[MAX_DS_LEVEL][MAX_DS_RANK];
};

extern CDevilSquare gDevilSquare;

static struct _DEVILSQUARE_LEVEL
{
...
} gDEVILSQUARE_LEVEL[MAX_DS_LEVEL-1] =
{
	// Devil Square 1
	15, 130, // DK, DW, Elf
	10, 110, // MG, DL
