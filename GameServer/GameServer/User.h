...
#define MAX_OBJECT 12500
#define MAX_OBJECT_MONSTER 10500
...
#if(MAX_LEVEL_TEST == 1)
#define MAX_CHARACTER_LEVEL 800
#else
...
#define MAX_CHAT_MESSAGE_SIZE 89
...
struct OBJECTSTRUCT
{
	...
	CItem* GuildWarehouse;
	BYTE* GuildWarehouseMap;
	int LoadGuildWarehouse;
	QWORD GuildWarehouseMoney;

	int PointsTimeSec;
	int PointsTime;
	int PointsCount;

	DWORD last_vote_time;

	bool is_use_auto_health;
	DWORD auto_health_tick;
...
bool gObjGuildWarehouseSearchSerialNumber(LPOBJ lpObj,DWORD serial);
