...
public:
	...
	void SendNamesToClient(int aIndex);
public:
	...
	int m_CustomStoreEnableJoB[MAX_ACCOUNT_LEVEL];
	int m_CustomStoreEnableJoS[MAX_ACCOUNT_LEVEL];
	int m_CustomStoreEnableJoC[MAX_ACCOUNT_LEVEL];
	int m_CustomStoreEnableWCC[MAX_ACCOUNT_LEVEL];
	int m_CustomStoreEnableWCP[MAX_ACCOUNT_LEVEL];
	int m_CustomStoreEnableWCG[MAX_ACCOUNT_LEVEL];
