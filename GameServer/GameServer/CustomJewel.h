...
struct CUSTOM_JEWEL_ITEM_REPLACE_INFO
{
	int index;
	int old_item_index;
	int new_item_index;
...
struct CUSTOM_JEWEL_INFO
{
	...
	int EnableSlotWing;
	int EnableSlotRing;
	int EnableSlotPendant;
	int SuccessRate[4];
	int SalePrice;
	char ModelName[32];
	CUSTOM_JEWEL_SUCCESS_INFO SuccessInfo;
	CUSTOM_JEWEL_FAILURE_INFO FailureInfo;
	//CUSTOM_JEWEL_ITEM_REPLACE_INFO replace_info;
	std::vector<CUSTOM_JEWEL_ITEM_REPLACE_INFO> replace_info;
};
...
public:
	...
	void set_replace_info(CUSTOM_JEWEL_ITEM_REPLACE_INFO info);
	...
	CUSTOM_JEWEL_ITEM_REPLACE_INFO* get_replace_info(int jewel_item_id, int item_id);
	...
	bool check_custom_jewel_change_item(CUSTOM_JEWEL_INFO* lpInfo,CItem* lpItem);
	...
	int custom_jewel_replace_item(int aIndex, CItem* lpItem,int slot,CUSTOM_JEWEL_ITEM_REPLACE_INFO* replace_info);
public:
