...
enum eEffectNumber
{
	...
	EFFECT_PREMIUM_BUFF1 = 210,
	EFFECT_PREMIUM_BUFF2 = 211,
	EFFECT_PREMIUM_BUFF3 = 212,
	EFFECT_PARTY_BUFF = 213,
	EFFECT_GUILD_BUFF = 214,
	EFFECT_NOOB_BUFF = 215,
};
...
public:
	...
	int GenerateEffectList(LPOBJ lpObj,BYTE* data);
