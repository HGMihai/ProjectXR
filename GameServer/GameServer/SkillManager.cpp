...
int CSkillManager::GetSkillRange(int index)
{
	std::map<int,SKILL_INFO>::iterator it = this->m_SkillInfo.find(index);
...
{
	//LogAdd(LOG_TEST,"UseAttackSkill [%d]",lpSkill->m_index);
	...
	if(lpObj->ComboSkill.CheckCombo(lpSkill->m_skill,aIndex) != 0)
	{
...
bool CSkillManager::RunningSkill(int aIndex,int bIndex,CSkill* lpSkill,BYTE x,BYTE y,BYTE angle,bool combo) // OK
{
	...
	switch(lpSkill->m_skill)
	{
		...
		case SKILL_NEIL:
			return this->SkillNeil(aIndex,bIndex,lpSkill,x,y,combo);
		case SKILL_GHOST_PHANTOM:
			return this->SkillGhostPhantom(aIndex,bIndex,lpSkill,x,y,combo);
		...
		case SKILL_MAGIC_CIRCLE:
			return this->SkillMagicCircle(aIndex,bIndex,lpSkill,combo);
		case SKILL_SHIELD_RECOVER:
			return this->SkillShieldRecover(aIndex,bIndex,lpSkill,combo);
		...
		case SKILL_SELF_EXPLOSION:
			return this->SkillSelfExplosion(aIndex,bIndex,lpSkill,combo);
...
{
	//LogAdd(LOG_TEST,"Twisting slash");
	LPOBJ lpObj = &gObj[aIndex];
...
bool CSkillManager::SkillNeil(int aIndex,int bIndex,CSkill* lpSkill,BYTE x,BYTE y,bool combo) // OK
{
	LPOBJ lpObj = &gObj[aIndex];
...
bool CSkillManager::SkillGhostPhantom(int aIndex,int bIndex,CSkill* lpSkill,BYTE x,BYTE y,bool combo) // OK
{
	LPOBJ lpObj = &gObj[aIndex];
...
bool CSkillManager::SkillGhostPhantomAreaAttack(int aIndex,int bIndex,CSkill* lpSkill,BYTE x,BYTE y,bool combo) // OK
{
	LPOBJ lpObj = &gObj[aIndex];
...
bool CSkillManager::SkillMagicCircle(int aIndex,int bIndex,CSkill* lpSkill,bool combo) // OK
{
	LPOBJ lpObj = &gObj[aIndex];
...
bool CSkillManager::SkillShieldRecover(int aIndex,int bIndex,CSkill* lpSkill,bool combo) // OK
{
	LPOBJ lpTarget = &gObj[bIndex];
...
bool CSkillManager::SkillSelfExplosion(int aIndex,int bIndex,CSkill* lpSkill,bool combo) // OK
{
	LPOBJ lpObj = &gObj[aIndex];
...
{
	//LogAdd(LOG_TEST,"Recv MultySkill");
	LPOBJ lpObj = &gObj[aIndex];
	...
	//LogAdd(LOG_TEST,"Multi Skill index = %d",skill);
...
void CSkillManager::CGSkillAttackRecv(PMSG_SKILL_ATTACK_RECV* lpMsg,int aIndex) // OK
{
	...
	//LogAdd(LOG_TEST,"Basic Skill index = %d",skill);
