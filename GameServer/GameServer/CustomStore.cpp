...
void CCustomStore::ReadCustomStoreInfo(char* section,char* path) // OK
{
	...
	this->m_CustomStoreEnableJoB[0] = GetPrivateProfileInt(section,"CustomStoreEnableJoB_AL0",0,path);
	this->m_CustomStoreEnableJoB[1] = GetPrivateProfileInt(section,"CustomStoreEnableJoB_AL1",0,path);
	this->m_CustomStoreEnableJoB[2] = GetPrivateProfileInt(section,"CustomStoreEnableJoB_AL2",0,path);
	this->m_CustomStoreEnableJoB[3] = GetPrivateProfileInt(section,"CustomStoreEnableJoB_AL3",0,path);

	this->m_CustomStoreEnableJoS[0] = GetPrivateProfileInt(section,"CustomStoreEnableJoS_AL0",0,path);
	this->m_CustomStoreEnableJoS[1] = GetPrivateProfileInt(section,"CustomStoreEnableJoS_AL1",0,path);
	this->m_CustomStoreEnableJoS[2] = GetPrivateProfileInt(section,"CustomStoreEnableJoS_AL2",0,path);
	this->m_CustomStoreEnableJoS[3] = GetPrivateProfileInt(section,"CustomStoreEnableJoS_AL3",0,path);

	this->m_CustomStoreEnableJoC[0] = GetPrivateProfileInt(section,"CustomStoreEnableJoC_AL0",0,path);
	this->m_CustomStoreEnableJoC[1] = GetPrivateProfileInt(section,"CustomStoreEnableJoC_AL1",0,path);
	this->m_CustomStoreEnableJoC[2] = GetPrivateProfileInt(section,"CustomStoreEnableJoC_AL2",0,path);
	this->m_CustomStoreEnableJoC[3] = GetPrivateProfileInt(section,"CustomStoreEnableJoC_AL3",0,path);

	this->m_CustomStoreEnableWCC[0] = GetPrivateProfileInt(section,"CustomStoreEnableWCC_AL0",0,path);
	this->m_CustomStoreEnableWCC[1] = GetPrivateProfileInt(section,"CustomStoreEnableWCC_AL1",0,path);
	this->m_CustomStoreEnableWCC[2] = GetPrivateProfileInt(section,"CustomStoreEnableWCC_AL2",0,path);
	this->m_CustomStoreEnableWCC[3] = GetPrivateProfileInt(section,"CustomStoreEnableWCC_AL3",0,path);

	this->m_CustomStoreEnableWCP[0] = GetPrivateProfileInt(section,"CustomStoreEnableWCP_AL0",0,path);
	this->m_CustomStoreEnableWCP[1] = GetPrivateProfileInt(section,"CustomStoreEnableWCP_AL1",0,path);
	this->m_CustomStoreEnableWCP[2] = GetPrivateProfileInt(section,"CustomStoreEnableWCP_AL2",0,path);
	this->m_CustomStoreEnableWCP[3] = GetPrivateProfileInt(section,"CustomStoreEnableWCP_AL3",0,path);

	this->m_CustomStoreEnableWCG[0] = GetPrivateProfileInt(section,"CustomStoreEnableWCG_AL0",0,path);
	this->m_CustomStoreEnableWCG[1] = GetPrivateProfileInt(section,"CustomStoreEnableWCG_AL1",0,path);
	this->m_CustomStoreEnableWCG[2] = GetPrivateProfileInt(section,"CustomStoreEnableWCG_AL2",0,path);
	this->m_CustomStoreEnableWCG[3] = GetPrivateProfileInt(section,"CustomStoreEnableWCG_AL3",0,path);
...
void CCustomStore::CommandCustomStoreOffline(LPOBJ lpObj,char* arg) // OK
{
	...
	//gOfflineData.SetOffline(lpObj,2);
...
void CCustomStore::OpenCustomStore(LPOBJ lpObj,int type) // OK
{
	...
	this->CommandCustomStoreOffline(lpObj, NULL);
}
...
void CCustomStore::OnPShopBuyItemCallbackRecv(LPOBJ lpObj,LPOBJ lpTarget,DWORD slot,DWORD WCoinC,DWORD WCoinP,DWORD GoblinPoint) // OK
{
	...
	gLog.Output(LOG_TRADE,"[SellPesonalShopItem][%s][%s] - (Account: %s, Name: %s, Value: %d, WCCValue: %d, WCPValue: %d, WGPValue: %d, Index: %04d, Level: %02d, Serial: %08X, Option1: %01d, Option2: %01d, Option3: %01d, NewOption: %03d, JewelOfHarmonyOption: %03d, ItemOptionEx: %03d, SocketOption: %03d, %03d, %03d, %03d, %03d)",lpTarget->Account,lpTarget->Name,lpObj->Account,0,PShopWCCValue,PShopWCPValue,PShopWGPValue,lpTarget->Inventory[slot].m_Index,lpTarget->Inventory[slot].m_Level,lpTarget->Inventory[slot].m_Serial,lpTarget->Inventory[slot].m_SkillOption,lpTarget->Inventory[slot].m_LuckOption,lpTarget->Inventory[slot].m_Option,lpTarget->Inventory[slot].m_NewOption,lpTarget->Inventory[slot].m_JewelOfHarmonyOption,lpTarget->Inventory[slot].m_ItemOptionEx,lpTarget->Inventory[slot].m_SocketOption[0],lpTarget->Inventory[slot].m_SocketOption[1],lpTarget->Inventory[slot].m_SocketOption[2],lpTarget->Inventory[slot].m_SocketOption[3],lpTarget->Inventory[slot].m_SocketOption[4]);
...
void CCustomStore::SendNamesToClient(int aIndex)
{
	PMSG_CUSTOMSTORE_SEND pRequest;
	//pRequest.Head.set((LPBYTE)&pRequest, 0xFB, 0x11, sizeof(pRequest));
	//pRequest.Head.set();
	pRequest.Head.set(0xFB,0x07, sizeof(pRequest));

	// ----
	memcpy(pRequest.m_CustomStoreJoBName, this->m_CustomStoreJoBName, sizeof(this->m_CustomStoreJoBName));
	memcpy(pRequest.m_CustomStoreJoSName, this->m_CustomStoreJoSName, sizeof(this->m_CustomStoreJoSName));
	memcpy(pRequest.m_CustomStoreJoCName, this->m_CustomStoreJoCName, sizeof(this->m_CustomStoreJoCName));
	memcpy(pRequest.m_CustomStoreWCCName, this->m_CustomStoreWCCName, sizeof(this->m_CustomStoreWCCName));
	memcpy(pRequest.m_CustomStoreWCPName, this->m_CustomStoreWCPName, sizeof(this->m_CustomStoreWCPName));
	memcpy(pRequest.m_CustomStoreWCGName, this->m_CustomStoreWCGName, sizeof(this->m_CustomStoreWCGName));
	// ----
