...
public:
	...
	bool SkillNeil(int aIndex,int bIndex,CSkill* lpSkill,BYTE x,BYTE y,bool combo);
	bool SkillGhostPhantom(int aIndex,int bIndex,CSkill* lpSkill,BYTE x,BYTE y,bool combo);
	bool SkillGhostPhantomAreaAttack(int aIndex,int bIndex,CSkill* lpSkill,BYTE x,BYTE y,bool combo);
	...
	bool SkillMagicCircle(int aIndex,int bIndex,CSkill* lpSkill,bool combo);
	bool SkillShieldRecover(int aIndex,int bIndex,CSkill* lpSkill,bool combo);
	...
	bool SkillSelfExplosion(int aIndex,int bIndex,CSkill* lpSkill,bool combo);
