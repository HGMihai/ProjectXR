...
LRESULT CALLBACK Disconnect(HWND hDlg,UINT message,WPARAM wParam,LPARAM lParam);
LRESULT CALLBACK AdminChat(HWND hDlg,UINT message,WPARAM wParam,LPARAM lParam);
