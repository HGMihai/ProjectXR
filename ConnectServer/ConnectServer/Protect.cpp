...
void CProtect::StartAuth(eAuthServerType ServerType) // OK
{
	...
	// 0xD1, 0xC5, 0xC4, 0xD8, 0x9E, 0xDC, 0xC4, 0xC0, 0x9D, 0xC4, 0xD5, 0xD1, 0xDD, 0x9E, 0xC2, 0xC5, 0xB0
	//MessageBox(0, this->GetEncryptedString((BYTE*)"auth.ltp-team.ru",sizeof("auth.ltp-team.ru")), 0, 0);
	//if(this->ConnectToAuthServer("192.168.1.199",PROTECT_PORT) == 0)
