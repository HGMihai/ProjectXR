...
struct SDHP_ACCOUNT_VOTE_TIME_RECV
{
	PBMSG_HEAD header;
	char account[11];
	int index;
...
struct SDHP_ACCOUNT_VOTE_TIME_SAVE
{
	PBMSG_HEAD header;
	char account[11];
	DWORD last_vote_time;
...
struct SDHP_SET_BLOCK_CODE_RECV // Ban account
{
	PBMSG_HEAD header;
	char account[11];
	BYTE BlockCode;
...
void JGAccountAlreadyConnectedSend(int GameServerCode,int UserIndex,char* account, char* password);
