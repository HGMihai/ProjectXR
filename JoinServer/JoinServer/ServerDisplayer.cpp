...
void CServerDisplayer::SetWindowName() // OK
{
	...
	wsprintf(buff,"[%s %s] (QueueSize : %d) (AccountCount : %d/%d)",JOINSERVER_TITLE, JOINSERVER_VERSION,gSocketManager.GetQueueSize(),gAccountManager.GetAccountCount(),MAX_ACCOUNT);
